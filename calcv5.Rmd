...
df$available_returns = rowSums(!is.na(df[,return_cols])) # compute number of available returns

df$cum_return = rowProds(1+as.matrix(df[,return_cols]), na.rm=T) # compute cumulative product
