...
return_mat = matrix(data= NA, ncol = 11 , nrow = nrow(df) ) %>% as_tibble()

names(return_mat) = paste0("return", sep = "_", 2:12)




dcast(df, 1 ~ cols)
temp_mat = t(tibble(cols = 0))
names(temp_mat, c(paste0("return", sep = "_", 2:12)))

#names(temp_mat) = c(1,2,3)
