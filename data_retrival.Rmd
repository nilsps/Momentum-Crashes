...
random_stocks = sample(1:length(temp_stock), numb_stocks, replace= FALSE) # Retrieve a 100 random stocks from the universe
...
randomizer = function(x){
  filter_data = tot_df %>% filter(symbol == tot_df[random_stocks_test[x]])
  return(filter_data)
}
