...
colors <- c("top" = "blue", "mid" = "red", "bot" = "orange")

ggplot(total_score, aes(x = date)) + # Uses main dataset
       geom_line(aes(y = top, color = "top"), size = 1.5) +
       geom_line(aes(y = mid, color = "mid" ), size = 1.5) +
       geom_line(aes(y = bot, color = "bot"), size = 1.5) + 
       labs(x = 'Date',
